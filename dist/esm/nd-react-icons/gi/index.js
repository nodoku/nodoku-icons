...
export function nameToReactIcon_gi(iconName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, nameToReactIcon_gi_0(iconName)];
                case 1:
                    _d = (_e.sent());
                    if (_d) return [3 /*break*/, 3];
                    return [4 /*yield*/, nameToReactIcon_gi_1(iconName)];
                case 2:
                    _d = (_e.sent());
                    _e.label = 3;
                case 3:
                    ...
                    return [4 /*yield*/, nameToReactIcon_gi_2(iconName)];
                case 4:
                    _c = (_e.sent());
                    _e.label = 5;
                case 5:
                    ...
                    return [4 /*yield*/, nameToReactIcon_gi_3(iconName)];
                case 6:
                    _b = (_e.sent());
                    _e.label = 7;
                case 7:
                    ...
                    return [4 /*yield*/, nameToReactIcon_gi_4(iconName)];
                case 8:
                    _a = (_e.sent());
                    _e.label = 9;
