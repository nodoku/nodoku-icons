...
export function nameToReactIcon_si(iconName) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, nameToReactIcon_si_0(iconName)];
                case 1:
                    _c = (_d.sent());
                    if (_c) return [3 /*break*/, 3];
                    return [4 /*yield*/, nameToReactIcon_si_1(iconName)];
                case 2:
                    _c = (_d.sent());
                    _d.label = 3;
                case 3:
                    ...
                    return [4 /*yield*/, nameToReactIcon_si_2(iconName)];
                case 4:
                    _b = (_d.sent());
                    _d.label = 5;
                case 5:
                    ...
                    return [4 /*yield*/, nameToReactIcon_si_3(iconName)];
                case 6:
                    _a = (_d.sent());
                    _d.label = 7;
