export default function mn_flag_4x3(className) {
    return (<svg className={className} xmlns="http://www.w3.org/2000/svg" fill="#ffd900" id="flag-icons-mn" viewBox="0 0 640 480">
