export default function mn_flag_1x1(className) {
    return (<svg className={className} xmlns="http://www.w3.org/2000/svg" fill="#ffd900" id="flag-icons-mn" viewBox="0 0 512 512">
