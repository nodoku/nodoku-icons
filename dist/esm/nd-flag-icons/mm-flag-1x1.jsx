export default function mm_flag_1x1(className) {
    return (<svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} id="flag-icons-mm" viewBox="0 0 512 512">
