export default function uz_flag_4x3(className) {
    return (<svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} id="flag-icons-uz" viewBox="0 0 640 480">
