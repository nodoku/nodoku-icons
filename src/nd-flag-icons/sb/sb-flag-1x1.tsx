...
export function sb_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-sb" viewBox="0 0 512 512">
  <defs>
    <clipPath id="sb-a">
      <path fillOpacity=".7" d="M0 0h496v496H0z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" strokeWidth="1pt" clipPath="url(#sb-a)" transform="scale(1.0321)">
