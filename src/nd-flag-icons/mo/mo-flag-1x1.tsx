...
export function mo_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} id="flag-icons-mo" viewBox="0 0 512 512">
  ...
  <use xlinkHref={"#mo-a"} width="100%" height="100%" transform="matrix(-1 0 0 1 512 0)"/>
</svg>
