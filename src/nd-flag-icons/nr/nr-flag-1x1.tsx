...
export function nr_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-nr" viewBox="0 0 512 512">
  <defs>
    <clipPath id="nr-a">
      <path fillOpacity=".7" d="M135.6 0h496.1v496h-496z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" strokeWidth="1pt" clipPath="url(#nr-a)" transform="translate(-140)scale(1.0321)">
