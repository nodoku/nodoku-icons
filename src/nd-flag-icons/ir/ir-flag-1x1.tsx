...
export function ir_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-ir" viewBox="0 0 512 512">
  <defs>
    <clipPath id="ir-a">
      <path fillOpacity=".7" d="M186 0h496v496H186z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" clipPath="url(#ir-a)" transform="translate(-192)scale(1.0321)">
