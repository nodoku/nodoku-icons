...
export function fm_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-fm" viewBox="0 0 512 512">
  <defs>
    <clipPath id="fm-a">
      <path fillOpacity=".7" d="M244.2 0h496v496h-496z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" strokeWidth="1pt" clipPath="url(#fm-a)" transform="translate(-252)scale(1.032)">
