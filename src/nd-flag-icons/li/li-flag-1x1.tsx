...
export function li_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} id="flag-icons-li" viewBox="0 0 512 512">
  <path fill="#002b7f" d="M0 0h512.1v256H0z"/>
  <path fill="#ce1126" d="M0 256h512.1v256H0z"/>
  <g fill="#ffd83d" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" transform="translate(-54)scale(.85333)">
    <g id="li-a">
    ...
    <path fill="none" strokeWidth="1.5" d="M219.3 89.9v6.6a62.5 62.5 0 0 0-7.4.8m20.2 0a62.1 62.1 0 0 0-7.5-.8v-6.6m-12.8 12.7a61.4 61.4 0 0 1 10.2-.9c3.4 0 6.8.3 10 .9"/>
