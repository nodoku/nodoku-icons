...
export function kp_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-kp" viewBox="0 0 512 512">
  <defs>
    <clipPath id="kp-a">
      <path fillOpacity=".7" d="M92.2 7.8h593.6v485.5H92.2z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" clipPath="url(#kp-a)" transform="matrix(.86254 0 0 1.0546 -79.5 -8.3)">
