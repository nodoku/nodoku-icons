...
export function tc_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} id="flag-icons-tc" viewBox="0 0 512 512">
  <path fill="#002868" d="M512 512V0H0v512z"/>
  <g fill="none" stroke="#000">
    <path fill="#fcd116" strokeWidth="8" d="M491 191.5v90c0 60-30 124.6-105 159.6-75-35-105-99.6-105-159.6v-90z"/>
    <path stroke="#fff" strokeWidth="7" d="M491 191.5v90c0 60-30 124.6-105 159.6-75-35-105-99.6-105-159.6v-90z"/>
    <g strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2">
      ...
      <path fill="#f1b2dc" strokeWidth=".3" d="M344.4 265.5c-1.4-3.3-2.9-6.5.7-13.5 3.8-7.1 1.4-12.5.3-16.1-1.1-3.5-1.4-6.8 0-8.3 1.5-1.3 2.1-2.2 2.2-4.6.1-2.3 2-1.5 2.3-.4s.5 3-1.5 6.4c-2 3.5 5.6 12 2.1 21.1-2.4 6.4.8 14.5 2 20.2s2 19-6.3 21c5.7-2.7.4-20.6-1.8-25.8"/>
