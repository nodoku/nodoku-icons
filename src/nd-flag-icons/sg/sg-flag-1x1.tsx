...
export function sg_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-sg" viewBox="0 0 512 512">
  <defs>
    <clipPath id="sg-a">
      <path fillOpacity=".7" d="M27.7 0h708.6v708.7H27.7z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" clipPath="url(#sg-a)" transform="translate(-20)scale(.72249)">
