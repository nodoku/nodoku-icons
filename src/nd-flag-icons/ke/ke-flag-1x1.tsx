...
export function ke_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} id="flag-icons-ke" viewBox="0 0 512 512">
  <defs>
  ...
  <use xlinkHref={"#ke-b"} width="100%" height="100%" transform="matrix(-1 0 0 1 511.7 0)"/>
  ...
  <use xlinkHref={"#ke-c"} width="100%" height="100%" transform="matrix(-1 0 0 1 511.7 0)"/>
