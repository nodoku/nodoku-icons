...
export function zm_flag_4x3(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-zm" viewBox="0 0 640 480">
  <defs>
    <clipPath id="zm-a">
  ...
  <g fillRule="evenodd" clipPath="url(#zm-a)" transform="translate(160)scale(.9375)">
    ...
    <g fill="#ef7d00" stroke="#000">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1" d="M300.1 65s13.6 7.2 19.4 6.7a10 10 0 0 1-3.8 2c1.4.6 5.4 2.7 11.4 1.4l-3.3 3s5.2 2 11-1a46.4 46.4 0 0 0-2.8 3.7l4.1.3"/>
    </g>
  </g>
</svg>
