...
export function ms_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-ms" viewBox="0 0 512 512">
  ...
  <path fill="#00a2bd" stroke="#000" strokeWidth="1.8" d="M286.1 131.4h196.4l-.2 140.2c1.6 56.3-33.4 91.2-97.8 107-45.8-11.4-98.6-35-98.6-105.4z"/>
  ...
  <path fill="#ff9a08" fillRule="evenodd" stroke="#000" strokeWidth=".8" d="m345.8 294.8 35 36.3c12-13.3 3.6-63-12.3-72.1-1.9 5.9-5.1 13-8.6 15.2-7.6 5.2-26.1 11.2-20 15 1.5-1.9 5.2-3.7 7 .6 2 6.9-7.8 7.3-7.8 7.3s-6.2-.8-7.3-7c-1-6.4 9.3-12.2 10.1-12.6 1-.3 14.4-4 16.7-15.9 2.8-11.8 5.8-10 6.3-10.2 17.7 1.7 29.2 33.3 29.9 55.5.6 22.2-9 37-10.8 38-1.8.9-42-47.9-42-47.9z"/>
  <path fill="#ff9a08" stroke="#000" strokeWidth=".8" d="m371.2 261 .3 65.5m-4.2-64.2.2 59.4m-4.5-50.8.3 47.2m-3.7-43.9.2 39.1m-3.9-37.3v33m-4-30.4v26.1m-3.5-24v20"/>
  <path fill="none" stroke="#ffdf00" strokeLinecap="round" d="m345.2 299 36 41.2"/>
  <path fill="none" stroke="#ffdf00" strokeLinecap="round" strokeWidth="1.4" d="M383 273s16.3 35.7 1.2 65M341 291.4s1.2-3.1 2.7-1.8m-5.6-7.3s-6.5 5.8-3 9.5"/>
  ...
  <path fill="none" stroke="#000" strokeWidth=".3" d="M407.6 169.1c0 1 .5 2.4 1.6 3 .3.5 1.4 2.1 3.7 1.9m.5-9a11 11 0 0 0-5.3-2.6m-8.8 35.6c-2 2.7-3.2 6.4-2.3 11.6 1 5.1 2.4 12.8-1.4 16.2m18.7 10.1c-2.6-.6-6.4-.6-8.5.9a8.2 8.2 0 0 1-7.9.4"/>
  ...
  <path fill="none" stroke="#000" strokeWidth=".3" d="M397.4 258.3c-1 4.5 3.3 13 1.1 19m-5.5 1.2c0 4 1 9 .8 13-.2 3.9 1.4 5.7 3.2 9.4 6.7 13.4 11.3 23 10.6 35.5 0 2.3.7 7.2-1.7 8.6m-12.6 3.4c.7 0 1.4-.3 2.3-2.4.8-2 3.6-14.5 2.5-23m1.3 9.6a27 27 0 0 1-1.3 12.4"/>
