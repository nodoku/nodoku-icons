...
export function km_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-km" viewBox="0 0 512 512">
  <defs>
    <clipPath id="km-a">
      <path fillOpacity=".7" d="M0 0h416.3v416.3H0z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" clipPath="url(#km-a)" transform="scale(1.23)">
