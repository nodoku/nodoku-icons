...
export function ag_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-ag" viewBox="0 0 512 512">
  <defs>
    <clipPath id="ag-a">
      <path fill="#25ff01" d="M109 47.6h464.8v464.9H109z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" clipPath="url(#ag-a)" transform="translate(-120 -52.4)scale(1.1014)">
