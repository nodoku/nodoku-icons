...
export function fj_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-fj" viewBox="0 0 512 512">
  ...
  <g strokeMiterlimit="4.8">
    ...
    <g strokeMiterlimit="3">
      <g fill="#fff" stroke="#000" strokeWidth=".8" transform="translate(-207.6 158.4)scale(.66486)">
    ...
    <g fill="#00a651" stroke="#000" strokeWidth=".8">
      <path strokeWidth=".5" d="M351 331.2s5.3 5 4 9.2c0 0 3.3-7.3-.3-9.4-3.7-2.2-3.8-.5-3.7.2z"/>
      <path fill="#964b36" strokeWidth=".5" d="M344.4 336s-1.4 1.9.1 3.2c0 0-1.6 2.4-.4 4.4 0 0-1 2.1-.7 4.4 0 0-.9 3.5 1 5.1 0 0 2 1 2.9.2 0 0 1.7-2.7.6-5.4 0 0 1.3-2.3-.1-5.1 0 0 .4-1.7-.8-3.6 0 0 .8-1.2.1-2.2 0 0-2.5-2.6-2.7-1z"/>
      <path strokeWidth=".5" d="M345.9 329.8s-6.3-12-10.7-12.5c-4.3-.5-4.6-4.8-4.6-4.8s.5 2 4 2 10.3 5 11 8.7c.8 3.8 1.5 3.3 1.5 3.3z"/>
      <path strokeWidth=".5" d="M345.9 329s2.3-15.2 12.2-15.5 6.6.8 9-.8c0 0-6.7 3.5-10.8 4-4.1.5-7.5 8.5-7.4 10 .1 1.5-2.2 4.4-3.4 3.4-1.1-1 .4-1.1.4-1.1z"/>
      <path strokeWidth=".5" d="M348.1 334.6s2.3-6 6.2-4c0 0-3-5.8-8.4-.8 0 0 2.4 3.3 2.3 4.8zm-7.5-6S344 342 339 346c0 0 .1-6.9-2.9-11s3-8.6 4.6-6.5z"/>
      <path strokeWidth=".5" d="M341 331s6 5.6 6.3 7.5c.4 1.9 1.7-5.6-1-7.8a13.8 13.8 0 0 0-5.8-2.5z"/>
      <path fill="#964b36" strokeWidth=".5" d="M330.1 345.8s.6 2.3 2 2.8c0 0 .1 1.7 1.4 2.3 0 0-.7 1.4.5 2.3 0 0-.3 3 .8 3.6 0 0 2.6-.2 3.5-1 0 0 .6-1.9-.9-3.8 0 0 .2-1.8-1.2-2.8 0 0 .4-2.5-1.4-3.4 0 0-.3-2-1.4-3 0 0-2.3 3.2-3.3 3z"/>
      <path strokeWidth=".5" d="M333 342.9s-7.7-2.9-12 1.2c0 0 6.6.9 7.5 2.2.8 1.3 4.9-2.1 4.6-3.4z"/>
      <path strokeWidth=".5" d="m330.7 347.7-1.4-1.1c-.8-.5-7.3-2.3-8.2 4 0 0-2.3-6.2 1.1-7 3.4-1 6.2 1 8.5 4m-5.1-12.7s2.4 5 3.3 5.4c.8.2 1.5-.7 1.5-.7s-3.2-4.6-4.8-4.7zm-1.8-8s-2-6.6-4.3-4.8c-2.4 1.7-1.8 6.5-1.8 6.5s-4.8-4.9-2-8.8c2.8-3.9 8.2.4 8.2 7.2z"/>
      <path fill="#964b36" strokeWidth=".5" d="M329.2 340.6s0 1.3 1 1.6c.8.4 2.4 1 2.4.3s-1.2-3.6-1.7-3.3c-.5.4-1.4.4-1.7 1.4z"/>
      <path strokeWidth=".5" d="M327.7 332.9s-.2-5.8 3.5-8c0 0 .8.2 1.2-1 0 0-3 7.3-2.2 11v.5"/>
      <path strokeWidth=".5" d="M328.5 325.8s6.8-14 15-9.1c0 0-8.6 1.7-11.7 7.9l-3.2 4.6z"/>
      <path strokeWidth=".5" d="M324.9 331s-2-9.4-3.3-10.7c-1.3-1.2-3.4-2.6-5.9-.5 0 0 4.4-3.9 9-.6 4.7 3.3 3.7 8.4 3.7 8.4l-.5 6.5-3.2-2.9"/>
      <path strokeWidth=".5" d="M332.1 342.1s-8.3-15.6-13.6-4.5c0 0-1 2.9 0 4 0 0-3-2.2-1.6-7.8 1.4-5.4 10.6-3 13.2 1.6 2.6 4.5 3.4 6.7 3 7-.4.2-1-.3-1-.3zm23.3 4.5s6-12.4 9.6-6.7c0 0 1 2.7-.6 3.9 0 0-2.3-3-4.5.6-2 3.5-1.2 3.2-1.2 3.2s-2.3.7-3.3-1z"/>
      <path strokeWidth=".5" d="M364.4 343.8s3.3 1.7 2.2 5.2c0 0 4.4-8.4-1.7-9.1 0 0 1.2 2.6-.4 3.9zm.4-8.6s8 2.3 8.2 5.7c0 0 1.3-6.5-3.2-8.5 0 0-5.4.8-5 2.8z"/>
      <path strokeWidth=".5" d="M368.3 324.8c3.4-6.6 7.7 2.2 7.7 2.2s1.5-7-2.8-8.2-7 14.7-7 14.7l-5 1.1s1.4-13.9 8.9-15.2l.9.2"/>
      <path strokeWidth=".5" d="M362.3 328.8s-4.8-9.7-8-10.7c-3.3-1 1.8-2.5 3.8-.7 2 2 5.7 4.3 5.3 9.3l-1 2.1zm-4.9 13.4s1.4-6.6 5.2-8.6c3.7-2 7.2-1.3 7.2-1.3s-4.5 1-5.2 3.3c-.8 2.3-2 2.4-2 2.4z"/>
      <path fill="#964b36" strokeWidth=".5" d="M355.4 346.6s-2.1 4-1.6 4.7c0 0-2.3 3.2-1.4 4.9 0 0 2.3 1.7 3.3 1 0 0 2.6-3.7 1.9-5.7 0 0 1.7-2.4 1-3.9 0 0-2.5.2-3.2-1z"/>
    ...
    <path fill="#fff" stroke="#000" strokeWidth=".7" d="M360.5 401.9c2-1.1 2.4-5.1 2.4-5.1-.4 1.4-4.1 2.9-4.1 2.9 2.7-1.7 6-9.4 6-9.4-.9 2.8-8 5-12.7 7.6-4.6 2.6-2.2 10-2.2 10a16 16 0 0 1-4.2-8.3c-.5-3.5-1.9-4.8-5-5.2-3.2-.4-5 3.1-5 3.1L331 400l4.7.2s3.4 1.1 3.4 3.8c0 2.7-3 13.3 2 19.3 3.4 4.1 16 6.5 16 6.5"/>
    <path fill="#fff" stroke="#000" strokeWidth=".7" d="M351.3 410.1s1-4.8 4-4.6c3.2.2 4.1-3.5 6-4.1 1.8-.6 11.4-3.1 12.5-7.8 0 0-1 7.6-9.7 11.4 0 0 7-2.3 7.9-3.9 0 0-3.2 6.8-10.8 7.9 0 0 7.2-.6 8.2-2.5 0 0-3.2 4.3-8.5 4.8 0 0 4.9 2 6.2.3 0 0-2.7 3.2-6 3.4l.9.3s-3.2 3.7-6.6 1.2c-3.5-2.5-3.6.6-3.6.6"/>
    <path fill="#fff" stroke="#000" strokeWidth=".7" d="M358.4 417.3s4 6.8 4.5 10.4c0 0 7.7 8.6 10.6 9 0 0-1.3.6-3.8-1.5 0 0 2 2.2 2.5 2.3.4 0-1.7-.2-2-.8 0 0 .8 1.3 1.4 1.5l-.6-.2s-1-.1-1.5-.5-.2 1-.2 1-1.2-.3-1.6-.7c-.4-.4.2.9.2.9l-1-.3-.8.5s0 .5-.6.1c-.4-.4-1.3 0-1.3 0s-.7.6-1 .2c-.3-.4-1.5 1.5-1.5 1.5l-5.1-12.3"/>
    ...
    <g fill="#964b36" stroke="#000" strokeWidth=".5">
      <path strokeWidth=".3" d="M438.8 395.6s5.5-7.4 10.5-5.4 8.2 2.9 8.2 2.9.1 5-2.5 5c-2.7 0-5.2-5-7.6-3.6-2.4 1.5-4.4 3.5-4.5 4.2-.2.7-6.4.9-4.1-3z"/>
      ...
      <path strokeWidth=".3" d="M416.7 433.2s-3 .7-3.6 4.9c-.6 4.2-4.7 6.3-5 6.5m49.4-51.6s-4.5 1.6-3.7 4.7"/>
    </g>
    <path fill="#fff200" stroke="#000" strokeWidth=".3" d="M423.1 402.1s.1-10.6 8.8-10.1c1.7.1.9 2 .9 2s1.9-1.3 2.7.8c0 0 2.8-1.2 3 1.5 0 0 3-.4 2.7 2 0 0 2-.4 2 1.3 0 0 2.3-1 2 1.4 0 0 2.6-1.7 2.2 1.4 0 0 2.7-1.8 3.6 1.3 1 3-2.7 9.7-6.2 11.4"/>
    ...
    <path fill="#00a651" stroke="#000" strokeWidth=".3" d="M418 415s-1.5-9.8 4.4-13c0 0 1-.2 1.7 1.2 0 0 3.1-1.3 3.2 1.3 0 0 1.5-1.2 2 .5 0 0 3.3-.7 2.6 1.8 0 0 2.8-.8 2.6 1.6 0 0 2.8-1 2.3 1 0 0 3-.6 2.3 1.8 0 0 3.6-.4 2.5 2.2 0 0 2.7-.7 2.1 1.4 0 0 3.6.6 2 2.8a24 24 0 0 1-9.8 7.2"/>
    <path fill="#00a651" stroke="#000" strokeWidth=".3" d="M414.8 425s-2.4-8.3 2.2-10.4c0 0 .8-.2 1 .6 0 0 1-1.3 1.8-.1 0 0 2.3-1.1 2.8.6 0 0 1.6-1.3 2.4.6 0 0 1.4-.6 1.4 1 0 0 2-1 2 1 0 0 2-.8 1.6 1.3 0 0 3 .4 2 1.8 0 0 2.7.7 1.7 1.8 0 0 2.9-.3 1.3 1.6 0 0 2.2-.7 1 1.7-1.3 2.4-5.1 5-7.9 5.4"/>
    <path fill="#00a651" stroke="#000" strokeWidth=".3" d="M417.7 431.4s-5.1-5-2.7-6.4c0 0 1 .3 1.4 1.4 0 0 1.3-1.8 2 0 0 0 1.8-.6 1.8.7l1.5 1s1.7 0 1.4 1c0 0 1.9-.2 1.8.8 0 0 1.6 0 1.5 1.1 0 0 2.7.5 1.5 1.9 0 0-4.9 1-8.3-.4 0 0-1.8-.6-2-1z"/>
    ...
    <path fill="none" stroke="#000" strokeWidth="2.8" d="M310.2 254v136.4c0 44.6 80.6 71.1 80.6 71.1s80.6-26.5 80.6-71V254z"/>
  </g>
