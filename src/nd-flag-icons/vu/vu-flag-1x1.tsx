...
export function vu_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} id="flag-icons-vu" viewBox="0 0 512 512">
  <defs>
    <clipPath id="vu-a">
  ...
  <g clipPath="url(#vu-a)" transform="scale(.56889 1.0779)">
