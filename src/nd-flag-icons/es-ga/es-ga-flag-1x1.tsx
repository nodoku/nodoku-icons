...
export function es_ga_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-es-ga" viewBox="0 0 512 512">
  <g fontSize="12">
  ...
  <g fontSize="12">
    ...
    <path fill="#c8b100" fillOpacity=".9" d="M249.1 282.5h-23.3s-2.3 20.8 15.7 27.2v1.8h3.7v2.5s-6.6 6-.8 12.8v2h1v3.5h1v5.3s-.8 19.4-20 28.7v1.2h51v-1.2a36 36 0 0 1-20-28.7v-5.3h1.2v-3.4h.9v-2.1c5.7-6.8-1-12.8-1-12.8v-2.5h4v-1.8c17.8-6.4 15.5-27.2 15.5-27.2z"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".3" d="M286.6 342.9h19.7m-19 1.5h18.4m-15 2.5h11.5m-12.3 11.5H303m-12.4 1.4h11.6m-11.6 2.8h11.5m-18.5 23.2h25.5m-32.7 5.9h40m-41.5.9h43" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="#bcac0b" stroke="#000" strokeWidth=".5" d="M303.8 176.6h-6.4v-10.4h2.5v-2h-2.5v-2.5h-2v2.4h-2.5v2.1h2.4v10.4h-6v1.4h14.5v-1.4" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".7" d="M278.3 195.4s-2 2 0 0 6.4-3.2 8.9-2.7c2.4.6-.5.9-1.3 1-.8 0-2.4.3-4.8 0" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".7" d="M314.6 196s2.1 2 0 0c-2-1.9-6.4-3.2-8.8-2.6-2.5.5.4.8 1.2.9.9 0 2.5.4 4.9 0" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="#bcac0b" stroke="#000" strokeWidth=".7" d="M291.1 189.3v22.3c-.2 2.2 2.7 5.3 4.8 6.2 0 0 5-1.6 5.3-6.2v-23.5h-1.7v20.4c0 2-1.4 5.8-3.3 6.4 0 0-3.6-.6-3.8-6.4v-19.8l-1.3.6" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".5" d="m296 236-7 3.6 6.3 4 7.5-3.8-6.8-3.8" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fff" d="m233.9 188.6-12 1.8s-.2 6.5.4 8l12.4-1.6s.5-6-.8-8.2"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="m280.6 236.8-10.5 1.6s-.2 5.7.3 7l10.9-1.4s.5-5.3-.7-7.2z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#058e6e" fillOpacity=".9" d="M232.6 190.8s-7.3.7-9 1.4v4.3s4.8-.8 9.1-1.1z"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="M279.5 238.8s-6.4.6-8 1.2v3.8s4.3-.7 8.1-1l-.1-4" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fff" d="m268.1 188.8 12 2s.2 6.4-.4 7.9l-12.3-1.6s-.5-6 .7-8.2"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="m310.7 237 10.6 1.7s.1 5.7-.4 7l-10.8-1.4s-.5-5.3.6-7.2z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#058e6e" fillOpacity=".9" d="M269.6 191.2s7.2.7 9 1.3l-.1 4.4s-4.8-.8-9.1-1.2v-4.5"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="M312 239.1s6.3.6 7.9 1.2l-.1 3.8s-4.2-.7-8-1l.1-4" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="M254.2 241.8s37-13.7 84.2 1.2m-82.7 6.7s35.9-13.4 80 .6m-79.8-9 7.2 2.1-5 5.4" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="red" d="m205.9 201 4.8-3.9-5.4-1s.7.8.6 1.6z"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="m256 247.8 4.2-3.5-4.7-.9s.6.7.5 1.4zm81.6-5.1-7.7 1.4 5.2 6" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="red" d="m296.1 201.3-3.3-3.4 4.8-.5s-1.4.8-1.4 1.6c0 .7.2 1.7 0 2.3"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="m335.3 248-2.9-3 4.2-.4s-1.2.7-1.2 1.4c0 .6.2 1.5 0 2zm-70-6.2c.6 0 1.2-.4 1.2-1 0-.4-.6-.9-1.2-.9-.7 0-1.2.5-1.2 1s.5 1 1.2 1zm20.6-2.3c.7 0 1.2-.4 1.2-1 0-.5-.5-.9-1.2-.9s-1.2.4-1.2 1c0 .5.5.9 1.2.9zm0 3.3c.7 0 1.2-.4 1.2-.9s-.5-1-1.2-1-1.2.5-1.2 1 .5 1 1.2 1zm20.3-3.1c.6 0 1.2-.5 1.2-1s-.6-1-1.2-1c-.7 0-1.2.5-1.2 1s.5 1 1.2 1zm20.1 3.7c.7 0 1.2-.5 1.2-1s-.5-1-1.2-1-1.2.5-1.2 1 .5 1 1.2 1zm-.3 2.6c.6 0 1.2-.4 1.2-1 0-.4-.6-.9-1.2-.9-.7 0-1.2.5-1.2 1s.5 1 1.2 1zm-19.8-3c.6 0 1.2-.4 1.2-1 0-.5-.6-.9-1.2-.9-.7 0-1.2.4-1.2 1 0 .5.5 1 1.2 1zm-40 3c.7 0 1.3-.4 1.3-1 0-.4-.6-.9-1.2-.9-.7 0-1.2.5-1.2 1s.5 1 1.2 1z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="#bcac0b" stroke="#000" strokeWidth=".7" d="M263.3 231.3a1.7 1.7 0 1 0 0-3.3 1.7 1.7 0 0 0 0 3.3z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fc0" d="M239 178.3a2 2 0 1 0 0-3.8 2 2 0 0 0 0 3.8"/>
    <path fill="#bcac0b" stroke="#000" strokeWidth=".7" d="M285.1 227.8a1.7 1.7 0 1 0 0-3.3 1.7 1.7 0 0 0 0 3.3z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fc0" d="M264.2 179.1a2 2 0 1 0 0-3.8 2 2 0 0 0 0 3.8"/>
    <path fill="#bcac0b" stroke="#000" strokeWidth=".7" d="M307.3 228.5a1.7 1.7 0 1 0 0-3.3 1.7 1.7 0 0 0 0 3.3z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fc0" d="M289.2 183a2 2 0 1 0 0-3.7 2 2 0 0 0 0 3.8"/>
    <path fill="#bcac0b" stroke="#000" strokeWidth=".7" d="M329.2 232a1.7 1.7 0 1 0 0-3.3 1.7 1.7 0 0 0 0 3.3z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".4" d="M296 226.8a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fff" d="M251.4 175.7a2 2 0 1 0 0-3.9 2 2 0 0 0 0 3.9"/>
    <path fill="none" stroke="#000" strokeWidth=".3" d="M296 225.5a1.7 1.7 0 1 0 0-3.4 1.7 1.7 0 0 0 0 3.4z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".4" d="M318 228.6a3 3 0 1 1 1.4-6 3 3 0 0 1-1.3 6z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fff" d="M276.9 177.7a2 2 0 1 1 .8-3.7 2 2 0 0 1-.8 3.7"/>
    <path fill="none" stroke="#000" strokeWidth=".3" d="M318.4 227.3a1.7 1.7 0 1 1 .7-3.3 1.7 1.7 0 0 1-.7 3.3z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".4" d="M273.2 228.4a3 3 0 1 0-.8-6 3 3 0 0 0 .8 6z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fff" d="M225.2 177.4a2 2 0 1 0-.4-3.8 2 2 0 0 0 .4 3.8"/>
    <path fill="none" stroke="#000" strokeWidth=".3" d="M273 227a1.7 1.7 0 1 0-.4-3.3 1.7 1.7 0 0 0 .4 3.3z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".4" d="M337.7 230.1a3 3 0 0 1 4.8-1.8c0 .5-.3 1.3-.8 1.8-.6.6-.7 1.6-.7 2a3 3 0 0 1-.4 1.6h-.5a3 3 0 0 1-2.4-3.6z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fff" d="M300.3 181.3a2 2 0 0 1 3.4-.8l-.3.4c-.7.7-.8 1.8-.8 2.3v.2h-.7c-1.1 0-1.7-1.1-1.5-2.2"/>
    <path fill="none" stroke="#000" strokeWidth=".3" d="M339 230.4a1.7 1.7 0 0 1 3-.7l-.3.4c-.6.6-.7 1.6-.7 2v.2h-.6c-1-.1-1.5-1-1.3-2z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    ...
    <path fill="none" stroke="#000" strokeWidth=".4" d="M254.8 229.4a3 3 0 0 0-4.6-2c0 .5.2 1.3.7 1.8.6.6.6 1.6.5 2 0 .2 0 1 .4 1.7h.4a3 3 0 0 0 2.6-3.5z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="#fff" d="M203 180.4a2 2 0 0 0-3.4-1l.5.5c.7.7.7 1.8.5 2.3v.2h.8c1 0 1.7-1 1.6-2"/>
    <path fill="none" stroke="#000" strokeWidth=".3" d="M253.5 229.6a1.7 1.7 0 0 0-3-.9l.4.5c.6.6.6 1.6.5 2v.2h.7c.9 0 1.5-.9 1.4-1.8z" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="none" stroke="#000" strokeWidth="1.5" d="M257.2 251.6s33.8-13.2 76.4.3" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="M338.4 241.1c-47.1-15-84.7-.8-84.7-.8" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
    <path fill="red" d="m251.4 189.7-4.3 2.2 3.8 2.3 4.6-2.2z"/>
    <path fill="none" stroke="#000" strokeWidth=".5" d="m296 237.8-3.8 1.9 3.4 2.1 4-2-3.6-2" transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"/>
  </g>
</svg>
