...
export function by_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} xmlSpace={"preserve"} id="flag-icons-by" viewBox="0 0 512 512">
  <defs>
    <clipPath id="by-a">
      <path d="M0 0h200v608h8v284l-8 8H0Z"/>
    </clipPath>
  </defs>
  <path fill="#ce1720" strokeWidth="1.91554" d="M0 0h512v512H0Z"/>
  <g fill="#fff" clipPath="url(#by-a)" transform="matrix(.5625 0 0 .56889 5 0)">
    <g id="by-c">
  ...
  <path fill="#007c30" strokeWidth="1.7899" d="M117.3 341.3h395V512h-395z"/>
</svg>
