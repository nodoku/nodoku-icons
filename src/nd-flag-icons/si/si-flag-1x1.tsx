...
export function si_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-si" viewBox="0 0 512 512">
  <defs>
    <clipPath id="si-a">
      <path fillOpacity=".7" d="M60.2 0h497.3v497.3H60.2z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" strokeWidth="1pt" clipPath="url(#si-a)" transform="translate(-62)scale(1.0295)">
