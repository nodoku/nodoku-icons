...
export function kn_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-kn" viewBox="0 0 512 512">
  <defs>
    <clipPath id="kn-a">
      <path fillOpacity=".7" d="M151.7-.3h745.1v745H151.7z"/>
    </clipPath>
  </defs>
  <g fillRule="evenodd" clipPath="url(#kn-a)" transform="translate(-104.2 .2)scale(.68714)">
