...
export function py_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-py" viewBox="0 0 512 512">
  ...
  <path fill="#fedf00" stroke="#000" strokeWidth=".5" d="m264.6 266.1-8.1-5.6-8 5.6 3-9-7.1-5.5h9l3.1-9 3 9h9.1l-7 5.6 3 9z"/>
</svg>
