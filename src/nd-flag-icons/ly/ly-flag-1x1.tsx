...
export function ly_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-ly" viewBox="0 0 512 512">
  <defs>
    <clipPath id="ly-a">
      <path d="M250 12h500v500H250z"/>
    </clipPath>
  </defs>
  <g clipPath="url(#ly-a)" transform="translate(-256 -12.3)scale(1.024)">
