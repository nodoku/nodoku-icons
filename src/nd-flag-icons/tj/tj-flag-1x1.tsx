...
export function tj_flag_1x1(props: IconBaseProps, className: string): JSX.Element {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" xlinkHref={"http://www.w3.org/1999/xlink"} id="flag-icons-tj" viewBox="0 0 512 512">
  ...
  <g fill="#f8c300" transform="translate(-256)scale(.73143)">
    ...
    <use xlinkHref={"#tj-a"} width="100%" height="100%" transform="matrix(-1 0 0 1 1400 0)"/>
    ...
    <use xlinkHref={"#tj-b"} width="100%" height="100%" transform="rotate(9.4 700 804)"/>
    <use xlinkHref={"#tj-b"} width="100%" height="100%" transform="rotate(18.7 700 804)"/>
    ...
    <g transform="translate(700 380)">
      ...
      <use xlinkHref={"#tj-d"} width="100%" height="100%" transform="scale(-1 1)"/>
    </g>
  </g>
</svg>
