...
export function nameToReactIcon_gi(iconName: string): IconType | undefined {

    return (
        nameToReactIcon_gi_0(iconName) ||
        nameToReactIcon_gi_1(iconName) ||
        nameToReactIcon_gi_2(iconName) ||
        nameToReactIcon_gi_3(iconName) ||
        nameToReactIcon_gi_4(iconName) ||
        undefined
    );
